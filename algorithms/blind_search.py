        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT: running = False
                ...
                if current_ui_state == "selecting":
                    ...
                    start_y = HEIGHT // 2 - puzzle_h // 2 + 50

                    if len(initial_states) == 2:
                        print(f"Drawing selection screen with {len(initial_states)} states.")
                    ...
                    if common_path:
                         ...
                         path_rect = path_surf.get_rect(center=(WIDTH // 2, 140))
            ...
            if current_ui_state == "animating" and all_tiles_at_target and common_path:
                 if current_move_index < len(common_path):
                      ...
                      for move_idx in range(current_move_index + 1):
